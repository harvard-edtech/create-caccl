...
var createCACCL = function () {
    ...
    // Dev
    topPackageJSON.scripts['dev:canvas'] = 'npx caccl-canvas-partial-simulator';
    ...
    // Perform update
    var clientPackageFilename = path_1.default.join(currDir, 'package.json');
    var clientPackageJSON = (0, getPackageJSON_1.default)(clientPackageFilename);
    clientPackageJSON.scripts = ((_b = clientPackageJSON.scripts) !== null && _b !== void 0 ? _b : {});
    // Settings
    ...
    // Write
    (0, writePackageJSON_1.default)(clientPackageFilename, topPackageJSON);
    /*----------------------------------------*/
    /*                  CACCL                 */
    /*----------------------------------------*/
    // Print step title
    ...
    serverPackageJSON.scripts = ((_c = serverPackageJSON.scripts) !== null && _c !== void 0 ? _c : {});
    // Settings
